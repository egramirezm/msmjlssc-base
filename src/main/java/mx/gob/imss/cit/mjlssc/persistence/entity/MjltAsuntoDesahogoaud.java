...
@Entity
@Table(name = "MJLT_ASUNTO_DESAHOGOAUD")
public class MjltAsuntoDesahogoaud implements Serializable {
    private static final long serialVersionUID = -7315194176382793659L;
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "CVE_ASUNTO_DESAHOGOAUD", nullable = false)
    private Integer id;
