...
@Entity
@Table(name = "SSCC_TIPO_PRUEBA", catalog = DataBaseShemaConf.SCHEMANML)
public class SsccTipoPrueba implements Serializable {
	
    private static final long serialVersionUID = -1476746045219992773L;
    
    @Id
    @GeneratedValue(strategy = GenerationType.IDENTITY)
    @Column(name = "CVE_TIPO_PRUEBA", nullable = false)
    private Integer id;

    @Size(max = 60)
    @Column(name = "DES_TIPO_PRUEBA", length = 60)
    ...
    public String getDesTipoPrueba() {
        return desTipoPrueba;
    }

    public void setDesTipoPrueba(String desTipoPrueba) {
        this.desTipoPrueba = desTipoPrueba;
    }
